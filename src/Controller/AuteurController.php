...
use App\Form\AuteurGenrebyorderType;
...
class AuteurController extends AbstractController
{
    ...
    /**
     * @Route("/aut", name="auteur_liv", methods={"POST","GET"})
     */
    public function findauteur(AuteurRepository $auteurRepository): Response {
        return $this->render('auteur/auteur.html.twig', [

            'auteurs' => $auteurRepository->findBylivre(),
        ]);
     ...
     */
    public function show(Auteur $auteur,GenreRepository $genreRepository,AuteurRepository $auteurRepository): Response
    {
        return $this->render('auteur/show.html.twig', [
            'auteur' => $auteur,
            'genres'=>$genreRepository->findgenreauteur($auteur->getid()),
            'chro'=>$auteurRepository->findBygenrechrono($auteur->getid())
        ]);
    }
